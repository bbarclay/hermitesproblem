...
(function() {
  ...
  note = {Accessed on ${month} ${date.getDate()}, ${year}}
    ...
    function initializeMathHelper() {
        ...
        const mathTerms = {
            'cubic irrational': 'An irrational number that is a root of a cubic polynomial with rational coefficients',
            'projective space': 'A geometric space where parallel lines intersect at points at infinity',
            'companion matrix': 'A matrix whose characteristic polynomial is the polynomial being studied',
            'sin²-algorithm': 'A method using the squared sine of the argument of complex roots to determine periodicity',
            'periodicity': 'The property of a sequence repeating after a certain number of elements',
            'trajectory': 'The path followed by a point through successive transformations',
            'trace': 'The sum of the diagonal elements of a matrix',
            'modular periodicity': 'Periodicity with respect to a modular arithmetic system'
        };
